...
public class ShopController {
     ...
     */
    @GetMapping("/shops/{id}")
    public ResponseEntity<ApiResponse> getOneShop(
    ...
    public ResponseEntity<ApiResponse> deleteShop(@PathVariable UUID id,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        Long userId = userDetails.getUser().getId();
    ...
    public ResponseEntity<ApiResponse> makePrivateShop(@PathVariable UUID id,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        Long userId = userDetails.getUser().getId();
